...
const Provider = ({ children, fonts }) => {
    ...
    const show = ({ title, description, type, buttons }) => {
        ...
        setButtons((buttons === null || buttons === void 0 ? void 0 : buttons.sort((a, b) => (buttons.length > 2 ? a.style : b === null || b === void 0 ? void 0 : b.style) === types_1.ButtonStyle.Cancel ? 1 : -1)) || [{ text: 'OK', style: types_1.ButtonStyle.Bold }]);
    };
